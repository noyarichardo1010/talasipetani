...
export default class NotifService {
  constructor(onRegister, onNotification, navigation) {
    ...
    PushNotification.configure({
      onNotification: function (notification) {
        ...
        // Menghandle notifikasi saat diterima
        // if (notification?.title === 'Panggilan Masuk') {
        //   navigation.navigate('Panggilan', {
        //     data: notification?.data,
        //   });
        // }

        // if (notification?.action === 'Terima Panggilan') {
        //   navigation.navigate('Panggilan', {
        //     data: notification?.data,
        //   });
        // }

        switch (notification?.data?.content_type) {
          case 'CHAT':
            navigation.navigate('RoomChat', {
              chat: JSON.parse(notification?.data?.chat_json),
            });
            break;
          case 'OFFER':
            console.log('notif data offer', notification?.data);
  ...
  callNotif(subText, title, desc, data, soundName) {
    this.lastId++;
    PushNotification.localNotification({
      ...
      subText: subText ? subText : 'This is a subText', // (optional) default: none
      ...
      actions: ['Terima Panggilan', 'Tolak Panggilan'], // (Android only) See the doc for notification actions to know more
  ...
  localNotif(subText, title, desc, data, soundName) {
    this.lastId++;
    PushNotification.localNotification({
      /* Android Only Properties */
      ...
      groupSummary: false, // (optional) set this notification to be the group summary for a group of notifications, default: false
      ongoing: false, // (optional) set whether this is an "ongoing" notification
      // actions: [actionYes ? actionYes : null, actionNo ? actionNo : null], // (Android only) See the doc for notification actions to know more
      invokeApp: true, // (optional) This enable click on actions to bring back the application to foreground or stay in background, default: true
